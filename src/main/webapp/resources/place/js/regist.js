...
$(document).ready(function () {
    ...
    $("#btn1").click(function () {
        ...
        base_num = $(".base_num").val();
     	extraChrg = $(".extra_chrg").val();
        var html =
            "<tr><td>" +
            num +
            "</td><td><input type='text' name='roomTitle' value='" +
            room_title + "' readonly style='border:none;text-align:center;'/>" +
            "</td><td><input type='text' name='defaultCapa' value='" +
            base_num + "' readonly style='border:none;text-align:center;'/>" +
            "</td><td><input type='text' name='surcharge' value='" +
            extraChrg + "' readonly style='border:none;text-align:center;'/>" +
            "</td><td style='text-align:center;'><button class='del-btn-room btn btn-danger' idx='" +
            counterRoom +
            "'> X </button></td></tr>";
    ...
    $("#tag").on("keypress", function (e) {
        ...
        if (e.key === "Enter" || e.keyCode == 32) {
            ...
            if (tagValue !== "") {
                ...
                if (result.length == 0) {
                    $("#tag-list").append(
                        "<li class='tag-item' value='" + tagValue + "'>#" +
                        tagValue +
