...
<body style="min-height: 1000px">
	...
	<div class="h_column_center"
		style="position: fixed; display: none; z-index: 1001; top: 0; width: 100%; height: 0;"
		id="payment-popup"></div>


	<div id="searhc_vue" class="search_container"
		style="position: fixed; top: 100px; left: 0px; width: 100%; height: 100%; display: none; z-index: 9999; background-color: rgba(0, 0, 0, 0.2);">
		<div
			style="width: 100%; height: 100%; display: flex; flex-direction: column">
			<div class="h_column_center"
				style="width: 100%; background-color: rgb(255, 255, 255)">
				<div class="h_column_center"
					style="background-color: rgb(255, 255, 255); width: 964px; position: relative; margin-bottom: 40px;">
				</div>
			</div>
		</div>
	</div>
	...
	<div id="main_vue" class="h_column_center" style="min-height: 1000px">
		<div style="width: 1160px">
			...
			<p
				style="margin-top: 8px; font-size: 32px; font-weight: bold; font-stretch: normal; font-style: normal; line-height: 1.31; letter-spacing: -0.3px; color: rgb(27, 29, 31);">
								...
								<div
									...
									<c:forEach var="detailRoom" items="${detailInfoList }"
										...
										<div>
											...
											<input type="hidden" value="default24"
											...
											<div class="h_row_center"
												...
												<div class="h_row_center"
													...
													<div
														...
														id="people_minus">
														<img src=" web/images/icon/minus.svg"
															style="width: 20px; height: 20px" />
													</div>
													<div
													...
													<div
														style="width: 40px; height: 44px; display: flex; flex-direction: row; align-items: center; justify-content: center; cursor: pointer;"
														id="people_plus">
														<img src=" web/images/icon/plus.svg"
															style="width: 20px; height: 20px" />
													</div>
												</div>
											</div>
		...
		<div class="direct_phone h_center"
			...
			<div
				...
				<div class="h_center"
					...
					<img src="web/images/icon/close.svg"
						style="width: 24px; height: 24px" />
				</div>
				<div
				...
				<div style="margin-top: 30px; padding: 0px 40px; height: 100%">
					<div class="h_row_center" style="width: 100%">
						<div id="flipsnap_photo_big_prev" class="h_center"
							...
							<img src=" web/images/icon/chevron_left_g.svg"
		...
		<div class="h_column_center"
			...
			<div id="bookmark_29386" class="h_center bookmark"
				...
				<img src=" web/images/icon/bookmark_bl_v4.svg"
					style="width: 24px; height: 24px" />
			</div>
			<div
				onclick="hourplace_v2.userLog('W', '/place/29386', 'click', 'place', 'share')"
