...
<body>
	...
	<div class="h_column_center" id="main_vue"
		...
		<div style="width: 1160px; min-height: 1000px; padding-bottom: 150px;">
			...
			<!-- div 사이 공간 값 -->
			<div style="margin-top: 50px"></div>
			<p class="h_info_container_title">예약 승인 하기</p>
			<div style="margin-top: 50px"></div>
			...
			<div class="faq-content">
				<c:forEach var="hostjoin" items="${hostInfoList}" begin="2" end="2"
					step="1" varStatus="status">
			...
			<div class="faq-content">
				<c:forEach var="hostjoin" items="${hostInfoList}" begin="3" end="3"
					step="1" varStatus="status">
