...
<title>Regist Place - yourplace</title>
<!-- JQuery Lib -->
...
<body>
	<div class="regist-div" style="display: inline;">
		...
		<form method="POST" enctype="multipart/form-data"
			...
			<div class="find-address" style="margin-top: 20px;">
				<input type="text" id="roadAddress" class="roadAddress"
					placeholder="도로명주소" size="50" name="placeAddr" readonly /> <input
					type="button" onclick="execDaumPostcode()"
					class="btn btn-primary btn-find-address" value="우편번호 찾기" />
			</div>
			<hr>
			<!-- 해시태그 시작 -->
			...
			<h3>제목</h3>
			<div>
				<input type="text" style="width: 100%" name="placeName"
			...
			<div>
				<div
					...
					<p>회원님의 개인정보 보호를 위해 등록 및 수정 과정에서 개인정보 또는 연락처 입력 시, 자동으로 편집되며 향후
						서비스 이용에 제약이 있을 수 있습니다.</p>
				</div>
				<div
			 ...
			 <label for="" style="font-size:14px;margin-left: 10px;" id="contentLen">0</label>
			<hr>
			<!--면적 | 전용면적-->
			<h3>면적</h3>
			...
			<div class="choose-floor">
				...
				<input type="hidden" value="" name="placeFloor" id="place_floor_rst">
			</div>
			<hr>
			<h3>장소 이용 규칙</h3>
			<!--장소이용규칙-->
...
- 기존의 가구 세팅 및 구조를 필요에 의해 변경하신 경우 마감시간 전에 원상복구 해주셔야 합니다.
			...
			<div>
				<div
					...
					<p>게스트에게 호스트님의 장소 주변 정보를 알려주세요. 교통, 식당, 주차, 숙박 등 주변 정보를 알려주면 많은
						도움이 됩니다.</p>
				</div>
				<div
			...
			<div class="extra-fee" id="extra-fee">
				...
				<div class="form-check add-one">
					<input class="form-check-input" type="radio" name="placeExtrachrg"
						...
						for="flexRadioDefault2"> 1인 추가 시 시간당 5,500원 </label> <label
						class="form-check-label extra-fee-content" for="flexRadioDefault2">
						설정 인원 초과 시 : 1인 추가 시 시간당 5,500원 할증 자동 적용(부가세 포함) </label>
				</div>
				<div class="form-check add-one-double">
					<input class="form-check-input" type="radio" name="placeExtrachrg"
						id="flexRadioDefault3" value="2" /> <label
						class="form-check-label extra-fee-sub-title"
						for="flexRadioDefault3"> 1인 추가 시 시간당 11,000원 </label> <label
						class="form-check-label extra-fee-content" for="flexRadioDefault3">
						설정 인원 초과 시 : 1인 추가 시 시간당 11,000원 할증 자동 적용(부가세 포함) </label>
				</div>
			</div>
			<hr>
