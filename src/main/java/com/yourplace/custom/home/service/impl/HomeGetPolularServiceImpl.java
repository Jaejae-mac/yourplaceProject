...
//인기장소 목록 8개를 불러온다.
@Service("homeGetPolularService")
public class HomeGetPolularServiceImpl implements HomeGetLatestService {
	...
	public List<PlaceCardVO> getLatestPlaceList() {
		List<PlaceCardVO> popularPlaces = homeDAO.getPopularPlaceList();
		DecimalFormat dc = new DecimalFormat("###,###,###,###");
		for(PlaceCardVO vo : popularPlaces) {
